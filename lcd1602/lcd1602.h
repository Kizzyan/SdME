...
//
// Opens a handle to the I2C device
// Turns on the LCD, sets the 4-bit mode and clears the memory
// Returns 0 for success, 1 for failure
//
// Parameters:
// - i2c_inst_t *i2c: Pointer to the I2C instance
// - uint8_t iAddr: I2C address of the LCD
//
int lcd1602Init(i2c_inst_t *i2c, uint8_t iAddr);
